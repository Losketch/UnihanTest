...
public class UnicodeTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unicode_test);
        initViews();
    ...
    private void processUnicodeFile() {
        int maxProgress = 0;
        try (InputStreamReader inputReader = new InputStreamReader(getResources().getAssets().open("Unicode.txt"));
            ...
            // 重新打开文件处理
            inputReader.close();
            try (InputStreamReader reReader = new InputStreamReader(getResources().getAssets().open("Unicode.txt"));
            ...
            e.printStackTrace();
            postError("读取 Unicode.txt 文件失败：" + e.getMessage());
        }
